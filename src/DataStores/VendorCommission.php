 ...
 * paid_via
 */
class VendorCommission extends WC_Data_Store_WP implements Interfaces\VendorCommission, WC_Object_Data_Store_Interface {
	...
	public function create( &$commission ) {
		...
		$wpdb->insert(
			$wpdb->prefix . 'wcvendors_commissions',
			array(
