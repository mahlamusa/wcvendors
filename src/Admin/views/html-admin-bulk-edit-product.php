...
<fieldset class="inline-edit-col-right">
	<div id="wcvendors-fields-bulk" class="inline-edit-col">
		...
		<?php do_action( 'wcvendors_product_bulk_edit_start' ); ?>
		...
		<?php do_action( 'wcvendors_product_bulk_edit_end' ); ?>

		<input type="hidden" name="wcvendors_bulk_edit" value="1"/>
		<input type="hidden" name="wcvendors_bulk_edit_nonce"
			   value="<?php echo esc_attr( wp_create_nonce( 'wcvendors_bulk_edit_nonce' ) ); ?>"/>
	</div>
</fieldset>
