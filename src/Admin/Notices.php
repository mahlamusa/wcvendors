...
class Notices {
	...
	public static function template_file_check_notice() {
		...
		$core_templates = WC_Admin_Status::scan_template_files( WCV_PLUGIN_PATH . 'templates' );
		$outdated       = false;
		...
		foreach ( $core_templates as $file ) {
			...
			if ( false !== $theme_file ) {
				$core_version  = WC_Admin_Status::get_file_version( WCV_PLUGIN_PATH . 'templates/' . $file );
